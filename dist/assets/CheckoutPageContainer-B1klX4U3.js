...
`,ie=()=>{const{identifier:d,isEmail:n}=_(),{modalOpen:l,setModalOpen:p,operateAddress:G,setOperateAddress:Q,setLoadAddAddress:H,loadAddAddress:Y,setAllAddressInfo:k,allAddressInfo:J,setLoadDeleteAddress:K,loadDeleteAddress:N}=i.useContext(v),{setValue:x}=B(),[m,w]=i.useState(null),[R,c]=i.useState(!0),[A]=O(),u=A.get("useDraft")==="true",I=T.get("sessionId");console.log(d,"identifier");const{data:W,loading:S,error:C,refetch:X}=F(z,{variables:{identifier:d,isEmail:n,state:"proposal",useDraft:u,sessionId:I},fetchPolicy:"cache-and-network",skip:!d||!n,onCompleted:r=>{console.log(r,"check data",r.checkoutpageformat),setTimeout(()=>{w(r.checkoutpageformat);const y={};r.checkoutpageformat.cart.data.forEach(a=>{y[a.strMeal]=a.numMeal});const{shippingInfo:D,fee:$,checkedAmount:Z,checkedItem:ee,checkedItems:se,shoppingCart:re}=r.checkoutpageformat,g=D.find(a=>a.isDefault===!0),[E,M]=Object.entries($.fee)[0];console.log(r,"check data",r.checkoutpageformat,g),k((a=>({...a,shippingInfo:r.checkoutpageformat.shippingInfo}))),x("selectedAddress",g?.uuid),x("shippingMethod",E),x("shippingFee",M),c(!1)},300)},onError:r=>{console.log(r),c(!1)}});return R||S||!m?e.jsx(b,{}):C?e.jsx(Box,{children:"something went wrong"}):e.jsx(i.Suspense,{fallback:e.jsx(b,{}),children:e.jsx(q,{itemInfo:m,useDraft:u})})};export{ie as default};
